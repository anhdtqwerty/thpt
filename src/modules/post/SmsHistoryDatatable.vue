...
export default {
  ...
  computed: {
    ...mapState('SmsHistory', ['historiesData', 'totalItems', 'pageText', 'searchParams']),
  ...
  methods: {
    ...mapActions('SmsHistory', ['requestPageSettings', 'searchHistories']),
    async refresh(query) {
      await this.searchHistories({ ...query, senderMethod: 'sms' })
    },
    async resend() {
