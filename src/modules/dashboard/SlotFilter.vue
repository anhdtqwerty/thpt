<template>
  <div>
    ...
    <v-radio-group v-model="time" style="with: 100%">
      <div class="pa-4">
    ...
    <v-card-actions>
      <v-spacer></v-spacer>
      <v-btn depressed small color="primary" @click="onFilterChanged">
        <v-icon left dark>mdi-magnify</v-icon>Lọc
      </v-btn>
    </v-card-actions>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    ...mapState('departmentDashboard', ['classes'])
  },
  created () {
