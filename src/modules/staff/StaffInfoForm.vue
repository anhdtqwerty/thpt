        ...
        <v-col cols="12">
            <v-card ref="form" flat>
                <v-card-text>
                    ...
                    ></v-text-field>
                    <v-text-field :disabled="!policies['update-staff-info']" ref="address" v-model="address" label="Địa Chỉ"
                                  placeholder="Nhập địa chỉ"></v-text-field>
                    <v-textarea :disabled="!policies['update-staff-info']" ref="notes" v-model="notes" label="Ghi Chú" placeholder="Nhập ghi chú"
                    ></v-textarea>
                </v-card-text>
