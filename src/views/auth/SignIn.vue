        ...
        <v-col style="background: #fff" cols="12" md="7">
          <div class="mx-sm-4 px-sm-4 mx-md-10 px-md-10 py-lg-16 xs-screen">
            ...
            <div class="d-flex justify-center py-3">
              <router-link :to="'/forgot-password'" class="font-italic text-decoration-none black--text"
                >Quên mật khẩu</router-link
              >
            </div>
            <v-divider class="#0D47A1" />
            <v-card-actions class="d-flex flex-column justify-content-center py-10">
              <v-btn color="#0D47A1" class="px-12 white--text" x-large @click="submit">Đăng Nhập</v-btn>
              <p class="pt-2">
                Không có tài khoản?
                <router-link class="blue--text text-decoration-none" :to="'/signup'">Đăng ký</router-link>
              </p>
            </v-card-actions>
          </div>
        </v-col>
